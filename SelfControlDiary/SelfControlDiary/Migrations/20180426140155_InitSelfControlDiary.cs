...
{
    public partial class InitSelfControlDiary : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseForce = table.Column<int>(nullable: false),
                    Bending = table.Column<int>(nullable: false),
                    Breath = table.Column<int>(nullable: false),
                    CCC = table.Column<int>(nullable: false),
                    ChSS = table.Column<int>(nullable: false),
                    Date = table.Column<DateTime>(nullable: false),
                    Exhalation = table.Column<int>(nullable: false),
                    Genchi = table.Column<int>(nullable: false),
                    Height = table.Column<int>(nullable: false),
                    Incline = table.Column<int>(nullable: false),
                    JEL = table.Column<int>(nullable: false),
                    ...
                    Shtange = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndicatorLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IndicatorLists_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IndicatorLists_StudentId",
